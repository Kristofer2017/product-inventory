    ...
    <div class="bg-white rounded-lg shadow-sm mb-6 p-4">
        <div class="flex flex-col sm:flex-row gap-4 items-center justify-between">
            ...
            <div class="flex gap-2 items-center">
                <livewire:movimientos.create-movement />
            </div>
        </div>
    </div>
            ...
            <table class="w-full">
                ...
                <thead class="bg-gray-50 border-b border-gray-200">
                    <tr>
                        ...
                        <th class="px-6 py-4 text-left">
                            <button wire:click="sortBy('producto')"
                                class="flex items-center gap-2 hover:text-blue-600 transition-colors group">
                                <span
                                    class="text-xs font-semibold text-gray-700 uppercase tracking-wider group-hover:text-blue-600">
                                    Producto
                        ...
                        <th class="px-6 py-4 text-left hidden lg:table-cell">
                            <button wire:click="sortBy('reason')"
                                class="flex items-center gap-2 hover:text-blue-600 transition-colors group">
                                <span
                                    class="text-xs font-semibold text-gray-700 uppercase tracking-wider group-hover:text-blue-600">
                                    Motivo
                        ...
                        <th class="px-6 py-4 text-left hidden md:table-cell">
                            <button wire:click="sortBy('reference_number')"
                                class="flex items-center gap-2 hover:text-blue-600 transition-colors group">
                                <span
                                    class="text-xs font-semibold text-gray-700 uppercase tracking-wider group-hover:text-blue-600">
                                    Referencia
                        ...
                        <tr>
                            <td colspan="6" class="px-6 py-12 text-center">
                                <div class="flex flex-col items-center justify-center">
                                    ...
                                    <p class="text-gray-400 text-sm mt-1">Los movimientos de inventario aparecerán aquí
                                    </p>
                                </div>
                            </td>
                        </tr>
