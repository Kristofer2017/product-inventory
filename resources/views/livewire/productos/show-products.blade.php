    ...
    <div class="bg-white rounded-lg shadow-sm mb-6 p-4">
        <div class="flex flex-col sm:flex-row gap-4 items-center justify-between">
            ...
            <div class="flex gap-2 items-center">
                <livewire:productos.edit-product />
                <livewire:productos.view-product />
                <livewire:productos.delete-product />
                <livewire:productos.create-product />
            </div>
        </div>
    </div>
                        ...
                        <tr class="hover:bg-gray-50 transition-colors">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex items-center justify-end gap-2">
                                    {{-- Ver producto --}}
                                    <button wire:click="$dispatch('viewProduct', { productId: {{ $product->id }} })"
                                    ...
                                    {{-- Editar producto --}}
                                    <button wire:click="$dispatch('editProduct', { productId: {{ $product->id }} })"
                                    ...
                                    {{-- Eliminar producto --}}
                                    <button wire:click="$dispatch('confirmDelete', { productId: {{ $product->id }} })"
