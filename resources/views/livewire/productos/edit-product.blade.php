                ...
                <form wire:submit.prevent="update">
                            ...
                            <div class="flex items-start gap-4">
                                ...
                                <label class="flex-1 cursor-pointer">
                                    <div class="w-full px-4 py-3 border-2 border-dashed border-gray-300 rounded-lg hover:border-blue-500 transition text-center">
                                        ...
                                        <p class="mt-1 text-sm text-gray-600">
                                            <span class="text-blue-600 font-medium">Cambiar imagen</span> o arrastra aquí
                                        </p>
                                ...
                                @if ($imagen)
                                    <div class="relative">
                                        ...
                                        <p class="text-xs text-center text-blue-600 mt-1">Nueva</p>
                                    </div>
                                @endif
                                ...
                                @if ($imagenActual && !$imagen)
                                    <div class="relative">
                                        <img src="{{ asset('storage/' . $imagenActual) }}" alt="Actual" class="h-24 w-24 object-cover rounded-lg border-2 border-gray-300">
                                        <button 
                                            type="button"
                                        ...
                                        <p class="text-xs text-center text-gray-600 mt-1">Actual</p>
                                    </div>
                                @endif
                            </div>
                    ...
                    <div class="bg-gray-50 px-6 py-4 flex items-center justify-end gap-3">
                        ...
                        <button 
                            ...
                            wire:target="update"
                        >
                            <span wire:loading.remove wire:target="update">Actualizar Producto</span>
